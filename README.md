...
| GSP351 | Migrate MySQL Data to Cloud SQL Using DMS: Challenge Lab | [gsp351.sh](gsp351.sh) | [docs/gsp351.md](docs/gsp351.md) | Terverifikasi, skor 100/100 (us-central1), dua fase; destination existing wajib `demote-destination` dulu | 2026-08-22 |
...
| ARC102 | Store, Process, and Manage Data on Google Cloud - Command Line: Challenge Lab | [arc102.sh](arc102.sh) | [docs/arc102.md](docs/arc102.md) | Terverifikasi, skor 100/100 (us-east1); gen1 wajib (imagemagick), nama topic diacak lewat `TOPIC` | 2026-08-22 |
...
| ARC114 | Analyze Speech and Language with Google APIs: Challenge Lab | [arc114.sh](arc114.sh) | [docs/arc114.md](docs/arc114.md) | Maks 75/100 — Task 1-3 hijau (API key wajib dibuat lewat console); checkpoint Task 4 rusak — 4 instance, 15 hipotesis, termasuk bukti metrik API. Baca runbook sebelum mengulang | 2026-08-21 |

...
| ARC100 | Store, Process, and Manage Data on Google Cloud: Challenge Lab | [arc100.sh](arc100.sh) | - | Belum diuji; nama topic diacak per instance, wajib diisi lewat `TOPIC` | - |

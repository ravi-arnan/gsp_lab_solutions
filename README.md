...
| GSP1043 | Consuming Customer Specific Datasets from Data Sharing Partners | [gsp1043.sh](gsp1043.sh) | - | Belum diuji; tiga project, empat fase (`partner`/`publisher`/`customer`/`insert`) | - |

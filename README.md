...
| ARC111 | Implement Cloud Storage and Data Protection Solutions: Challenge Lab | [arc111.sh](arc111.sh) | - | Belum diuji; nama bucket diacak per instance, wajib diisi lewat `B1`/`B2`/`B3` | - |

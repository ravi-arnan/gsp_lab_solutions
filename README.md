...
| ARC114 | Analyze Speech and Language with Google APIs: Challenge Lab | [arc114.sh](arc114.sh) | [docs/arc114.md](docs/arc114.md) | Belum diuji di lab sungguhan; Task 2-4 otomatis (scp + ssh ke `lab-vm`), Task 1 bikin API key lewat console | 2026-08-09 |

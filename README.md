...
| GSP395 | Create and Manage AlloyDB Instances: Challenge Lab | [gsp395.sh](gsp395.sh) | [docs/gsp395.md](docs/gsp395.md) | Belum diuji; semua task otomatis, SQL dijalankan lewat SSH ke VM `alloydb-client` (private IP tidak terjangkau Cloud Shell) | - |

...
| ARC102 | Store, Process, and Manage Data on Google Cloud - Command Line: Challenge Lab | [arc102.sh](arc102.sh) | - | Belum diuji; gen1 wajib (imagemagick), nama topic diacak lewat `TOPIC` | - |

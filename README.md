...
| GSP364 | Monitor Environments with Managed Service for Prometheus: Challenge Lab | [gsp364.sh](gsp364.sh) | [docs/gsp364.md](docs/gsp364.md) | Belum diuji; semua task otomatis, PodMonitoring ditambahkan sendiri (tidak ada di example-app.yaml) | - |

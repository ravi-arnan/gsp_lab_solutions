...
| ARC114 | Analyze Speech and Language with Google APIs: Challenge Lab | [arc114.sh](arc114.sh) | [docs/arc114.md](docs/arc114.md) | Maks 75/100 — Task 1-3 hijau (API key wajib dibuat lewat console); checkpoint Task 4 rusak, dikonfirmasi ulang 2026-08-21 di instance ke-3 setelah lab di-update. Baca runbook sebelum mengulang | 2026-08-21 |
